...
export default function PartCatalogGrid({ componentIndex, parts, anatomies }) {
  ...
  return (
    <div style={{ width: '100%', maxWidth: 1200, padding: '5rem 0.5rem', margin: '0 auto'}}>
      {/* <PartCatalogFilters
        anatomies={anatomies}
        filters={filters}
        ...
        {parts
          ...
          .map((part) => {
            const size = scaleImages
              ? 200 / (part.scale == "1m" ? 2 : part.scale == "0.1m" ? 8 : 1)
              : 200;
            return (
              <Link
                key={part._id}
              ...
              >
                ...
                >
                  <line x1={0} x2={30} y1={0} y2={0}></line>
                  <line x1={0} x2={0} y1={30} y2={0}></line>
                </svg>
                <svg
                  viewBox="0 0 30 30"
                  style={{
                ...
                >
                  <line x1={0} x2={30} y1={0} y2={0}></line>
                  <line x1={30} x2={30} y1={30} y2={0}></line>
                </svg>
                <svg
                  viewBox="0 0 30 30"
                  style={{
                ...
                >
                  <line x1={0} x2={30} y1={30} y2={30}></line>
                  <line x1={30} x2={30} y1={30} y2={0}></line>
                </svg>
